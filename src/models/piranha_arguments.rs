...
use super::{
  default_configs::{
    ...
    C, GO, JAVA, KOTLIN, PYTHON, RUBY, SWIFT, TSX, TYPESCRIPT,
  },
...
pub struct PiranhaArguments {
  ...
  #[clap(short = 'l', value_parser = clap::builder::PossibleValuesParser::new([JAVA, C, SWIFT, PYTHON, KOTLIN, GO, TSX, TYPESCRIPT, RUBY])
